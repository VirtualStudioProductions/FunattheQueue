...
public class MenuFragment extends Fragment implements OnRequestSocialPersonCompleteListener {
    ...
    public static MenuFragment newInstannce(int id) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        socialNetwork = LoginActivityFragment.mSocialNetworkManager.getSocialNetwork(networkId);
